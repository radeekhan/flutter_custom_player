...
fun ExoPlayer.preparePlayer(playerView: PlayerView, forceLandscape:Boolean = false,
                            mainActivity: com.example.gotipath_player_app.MainActivity,methodChannel: io.flutter.plugin.common.MethodChannel) {
...
//        val fullScreenButton: ImageView = playerView.findViewById(R.drawable.sym_def_app_icon)
//        val normalScreenButton: ImageView = playerViewFullscreen.findViewById(R.drawable.sym_def_app_icon)
//        fullScreenButton.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.ic_media_ff))
//        normalScreenButton.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.ic_media_ff))
...
fun hideSystemUI(mainActivity: com.example.gotipath_player_app.MainActivity) {
...
fun showSystemUI(mainActivity: com.example.gotipath_player_app.MainActivity) {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
